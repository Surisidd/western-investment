<x-app-layout>
    ...
    <x-slot name="title">
     ...
     <a href=" {{route('emails.failed.thismonth')}} " role="button"  class="h6" data-bs-toggle="button" style="color:#6ACDE6" > Failed this month <span><i class="fas fa-arrow-circle-right"></i></span></a>
              ...
              <div class="col-lg-12 col-sm-12 col-12">
                <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap"
                  ...
                  <tbody>
                    ...
                    <td>
                      <a href=" {{route('contacts.show',$email->contact->ContactID)}} ">
