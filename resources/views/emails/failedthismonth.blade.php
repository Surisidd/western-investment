<x-app-layout>
    ...
    <x-slot name="title">
        <a href=" {{route('emails')}} " role="button"  class="h6" data-bs-toggle="button" style="color:#6ACDE6" > <span><i class="fas fa-arrow-circle-left"></i></span> All Emails </a>
<hr>
     Failed Emails this Month ( {{now()->format('F, Y')}} )
